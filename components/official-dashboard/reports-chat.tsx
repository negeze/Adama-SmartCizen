...
interface OfficialReportsChatProps {
  reportId: string
  citizenName: string
}

export function OfficialReportsChat({ reportId, citizenName }: OfficialReportsChatProps) {
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: '1',
      sender: 'citizen',
      name: citizenName,
      message: 'Hello, I am reporting an illegal parking situation that has been going on for weeks.',
      timestamp: '10:30 AM',
    },
    {
      id: '2',
      ...
      message: 'Thank you for reporting this issue. We have assigned this to our traffic team. Can you provide more details or photos?',
      timestamp: '10:35 AM',
    },
    {
      id: '3',
      sender: 'citizen',
      name: citizenName,
      message: 'Here are the photos I took yesterday showing the vehicles parked illegally.',
      timestamp: '10:40 AM',
      attachments: [
        { name: 'parking_violation_01.jpg', size: '2.4 MB' },
        { name: 'parking_violation_02.jpg', size: '1.8 MB' },
      ],
    },
  ])
  ...
  return (
    <div className="flex flex-col h-full bg-background">
      ...
      <div className="border-b border-border bg-card p-4">
        ...
        <p className="text-sm text-muted-foreground">Conversation with {citizenName}</p>
      </div>

      {/* Messages Container */}
      <div className="flex-1 overflow-y-auto p-6 space-y-6">
        {messages.map((msg) => (
          <div key={msg.id} className={`flex ${msg.sender === 'official' ? 'justify-end' : 'justify-start'}`}>
            <div className={`max-w-md ${msg.sender === 'official' ? 'bg-primary text-primary-foreground' : 'bg-secondary text-secondary-foreground'} rounded-lg p-4`}>
      ...
      <div className="border-t border-border bg-card p-6">
        ...
        <div className="flex gap-3">
          <textarea
            ...
            placeholder="Type your response or attach investigation documents..."
